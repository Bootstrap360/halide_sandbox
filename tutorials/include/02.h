...
void tutorial_02(float gain = 1.8f)
{
    ...
    Halide::Buffer<uint8_t> input = load_image("/root/repositories/halide_sandbox/images/rgb.png");
    ...
    save_image(output, "tutorial_02_brighter.png");
    printf("tutorial_02 success!\n");
